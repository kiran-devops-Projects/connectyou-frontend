                ...
                steps {
                    ...
                    script {
                        sh '''
                            ...
                            git clone -b manifest-files-frontend "https://x-access-token:${GIT_PASSWORD}@github.com/${GIT_ORG_NAME}/${DEPLOYMENT_REPO}.git" "${CLONE_DIR}" || { echo "❌ Clone failed"; exit 1; }
                            ...
                            if [ -f "${DEPLOYMENT_FILE}" ]; then
                                ...
                                if ! git diff --cached --quiet; then
                                    ...
                                    git push origin manifest-files-frontend || { echo "❌ Push failed"; exit 1; }
